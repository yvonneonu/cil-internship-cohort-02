            ...
            <Grid item xs={12}>
              <Stack spacing={2}>
                ...
                >
                  ...
                  >
                    {[ "React Components and JSX.", "React Router.", " Component state management.", "Context api for global state management.", "* Making asynchronous calls to the Json placeholder fake rest api using async/await."].map((value) => (
                      <ListItem
                        key={value}
                        disableGutters

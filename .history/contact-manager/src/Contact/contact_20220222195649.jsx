...
import InfoIcon from '@mui/icons-material/Info';import TwitterIcon from "@mui/icons-material/Twitter";
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar sx={{ alignItems: "center", justifyContent: "center", backgroundColor: "#e9ecef" }}>
      ...
      <main>
        ...
        <Container maxWidth="lg">
          ...
          >
            <Grid item xs={12} sx={{ backgroundColor: "#e9ecef", borderRadius: "0.3rem", marginBottom: "2rem", padding:"2rem 1rem", marginTop: "15px" }}>
              <Stack spacing={2}>
                <Box
                  sx={{
                    width: "100%",

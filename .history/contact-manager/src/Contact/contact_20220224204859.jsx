      ...
      <main>
        ...
        <Container maxWidth="lg">
          ...
          <Grid container spacing={4}>
            {users.map((user) => (
              <Grid item key={user} xs={12} sx ={{ display: 'flex', flexDirection: 'row' }}>
                <Grid xs={10} sx={{alignItems: "center", display: 'flex', flexDirection: 'row', justifyContent: 'center'}}>
                  <Typography >
                    {user.name} <KeyboardDoubleArrowDownIcon sx={{color: 'red'}} />
                  </Typography>
                </Grid>
